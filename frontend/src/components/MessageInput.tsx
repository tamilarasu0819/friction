      ...
      <div className="flex items-center space-x-3 max-w-5xl mx-auto">
        ...
        <div className="flex-1 relative">
          <input 
            ...
            className="w-full bg-slate-800 border border-slate-700 rounded-full py-3.5 px-6 text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all placeholder-slate-500 shadow-inner"
          />
        </div>
        <button className="p-2.5 text-slate-400 hover:text-slate-200 hover:bg-slate-800 rounded-full transition-colors shrink-0">
